  ...
  return <footer className="bg-primary text-primary-foreground">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-playfair font-bold"><span style={{fontFamily:"Cinzel, serif"}}><span style={{fontFamily:"Cinzel, serif", textTransform:"uppercase"}}>TEXTUS ACADÊMICO</span></span></span>
            </div>
      ...
      <div className="container mx-auto px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/60">
          <div>© 2025 <span style={{fontFamily:"Cinzel, serif", textTransform:"uppercase"}}>TEXTUS ACADÊMICO</span>. Todos os direitos reservados.</div>
